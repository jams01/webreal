...
<section id="content">
	<div id="main-content1">
		<article>
			<div class="heading">
				<h2><a href="#">Crear Estudiante</a></h2>
                                
			</div>
                    <div class="content">
                            <form method="post"  name="usuario" id="forusuarios" action="crearestudiante" >
                                <table style="width: 500px;margin: 0 auto; ">
                                    ...
                                    <tr style="height: 45px;">
                                        ...
                                        <td>Telefono</td><td><input id="personal" type="text" name="telefono" required/></td>
                                    </tr>
